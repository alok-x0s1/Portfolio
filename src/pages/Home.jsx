    ...
    <div className="bg-primary-bg-light text-primary-color-light dark:text-primary-color-dark dark:bg-primary-bg-dark min-h-screen">
      <Container>
        <div className="flex flex-col items-start pt-16 sm:pt-24 w-2/3 lg:w-full pl-8">
          ...
          <h1 className="text-8xl font-ubuntu mt-3 font-medium leading-tight sm:text-6xl xs:text-5xl">
            Alok Yadav.
          </h1>
          {/* <h3 className="text-7xl font-medium font-ubuntu opacity-75 leading-tight tracking-tighter">Weaving Web with Code Mastery</h3> */}
          <p className="text-xl font-medium opacity-75 font-infant mt-3 sm:text-lg xs:text-base">
