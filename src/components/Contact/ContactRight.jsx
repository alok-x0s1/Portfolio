...
const ContactRight = () => {
  return (
    <div className="bg-white dark:bg-black/50 min-h-96 flex justify-center p-8 rounded-md flex-col items-center gap-8 text-center border dark:border-secondary-color-dark">
