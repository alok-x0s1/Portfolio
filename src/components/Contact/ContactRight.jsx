...
const ContactRight = () => {
  return (
    <div className="bg-white dark:bg-black/50 min-h-96 flex justify-center p-8 md:p-4 sm:p-2 rounded-md flex-col items-center gap-8 text-center border dark:border-secondary-color-dark">
      ...
      <p className="px-12 md:px-8 sm:px-4 md:text-base md:w-full">I'm always interested in hearing about new projects and opportunities. Feel free to reach out to me if you have any questions or would like to discuss how I can help you with your upcoming creative endeavors.</p>
