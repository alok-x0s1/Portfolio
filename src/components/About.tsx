const About = () => {
	return (
		<div className="py-4 w-full flex flex-col gap-4 text-start text-base sm:text-lg tracking-wide leading-snug mb-4 text-zinc-300">
			<h2 className="font-display text-3xl sm:text-4xl font-semibold mb-6 text-white">
